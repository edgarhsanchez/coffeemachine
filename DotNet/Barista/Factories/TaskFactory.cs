...
namespace Barista.Factories {
    ...
    public static class TaskFactory {
        ...
        public static Func<CancellationToken, Task> CreateMakeCoffeeMessageTask(ILogger logger, CoffeeMachine.Interfaces.IClient coffeeMachineClient, Order order, IBackgroundTaskQueue queue) {
